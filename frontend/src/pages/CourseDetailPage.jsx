    ...
    <div className="min-h-screen bg-base-100">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <nav className="flex items-center gap-1 text-xs text-base-content/30 mb-6 flex-wrap">
          <Link to={ROUTES.HOME} className="hover:text-primary transition-colors">Bosh sahifa</Link>
          <IoChevronForward className="text-xs opacity-50" />
          <Link to={ROUTES.COURSES} className="hover:text-primary transition-colors">Kurslar</Link>
          <IoChevronForward className="text-xs opacity-50" />
