  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link to="/admin/videos/upload" className="btn btn-primary btn-sm gap-2">
        ...
        <div className="card bg-base-200 border border-base-300 overflow-hidden">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-48 text-base-content/40">
              ...
              <Link to="/admin/videos/upload" className="btn btn-primary btn-sm mt-3">Video yuklash</Link>
            </div>
          ) : (
