...
export const userApi = {
   ...
   */
  getUserStats: () =>
    axiosInstance.get('/api/xp/stats'),
  ...
  addVideoWatchXP: (videoId) =>
    axiosInstance.post(`/api/xp/video-watched/${videoId}`),
  ...
  getQuizByVideo: (videoId) =>
    axiosInstance.get(`/api/xp/quiz/video/${videoId}`),
  ...
  submitQuiz: (quizId, answers) =>
    axiosInstance.post(`/api/xp/quiz/${quizId}`, { answers }),
   ...
   */
  updateProfile: (data) =>
    axiosInstance.put('/api/xp/profile', data),
}
