...
- Name: error-handling.spec.ts >> Static Pages Load >> Blog page loads without errors
...
Call log:
  - navigating to "http://localhost:3001/blog", waiting until "load"
...
- main [ref=e2]:
  - generic [ref=e4]:
    - heading "Aidevix Blog" [level=1] [ref=e5]
    - paragraph [ref=e6]: Dasturlash olamidagi eng so'nggi yangiliklar va foydali maqolalar.
```
