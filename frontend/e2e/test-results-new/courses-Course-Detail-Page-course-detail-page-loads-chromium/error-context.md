...
- Name: courses.spec.ts >> Course Detail Page >> course detail page loads
- Location: e2e\courses.spec.ts:185:7
...
Call log:
  - navigating to "http://localhost:3001/courses/course-1", waiting until "load"
