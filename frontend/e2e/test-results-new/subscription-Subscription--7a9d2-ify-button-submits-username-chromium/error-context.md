...
- Name: subscription.spec.ts >> Subscription Verification >> Telegram verify button submits username
- Location: e2e\subscription.spec.ts:47:7
...
Call log:
  - waiting for locator('button').filter({ hasText: /tekshirish|verify|tasdiqlash/i }).first()
    - locator resolved to <button disabled class="w-full p-3 bg-white text-black font-bold rounded-xl hover:bg-zinc-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all">OBUNANI TEKSHIRISH</button>
        ...
        - generic [ref=e79]:
          ...
          - generic [ref=e109]:
            ...
            - generic [ref=e120]:
              ...
              - generic [ref=e129]:
                - textbox "Instagram username (@username)" [active] [ref=e130]: testuser_tg
