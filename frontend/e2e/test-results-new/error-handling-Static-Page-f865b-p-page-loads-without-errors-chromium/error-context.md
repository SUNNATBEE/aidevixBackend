...
- Name: error-handling.spec.ts >> Static Pages Load >> Help page loads without errors
...
Call log:
  - navigating to "http://localhost:3001/help", waiting until "load"
...
- main [ref=e2]:
  - generic [ref=e4]:
    - heading "Yordam markazi" [level=1] [ref=e5]
    - paragraph [ref=e6]: Savollaringiz bormi? Tez orada tez-tez so'raladigan savollar va yordam bo'limi ishga tushadi.
```
