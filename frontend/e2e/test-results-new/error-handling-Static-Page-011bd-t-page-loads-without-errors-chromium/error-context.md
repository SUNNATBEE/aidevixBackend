...
- Name: error-handling.spec.ts >> Static Pages Load >> Contact page loads without errors
...
Call log:
  - navigating to "http://localhost:3001/contact", waiting until "load"
...
- main [ref=e2]:
  - generic [ref=e4]:
    - heading "Aloqa" [level=1] [ref=e5]
    - paragraph [ref=e6]: "Savollaringiz bormi? Biz bilan bog'laning: support@aidevix.uz"
```
