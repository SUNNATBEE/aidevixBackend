...
- Name: error-handling.spec.ts >> Static Pages Load >> Careers page loads without errors
...
Call log:
  - navigating to "http://localhost:3001/careers", waiting until "load"
...
- main [ref=e2]:
  - generic [ref=e4]:
    - img [ref=e6]
    - heading "Aidevix Careers" [level=1] [ref=e8]
    - paragraph [ref=e9]: Eng yaxshi o'quvchilarimiz uchun nufuzli IT kompaniyalaridan ish o'rinlari va amaliyot dasturlari.
    - generic [ref=e10]:
      - generic [ref=e11] [cursor=pointer]:
        - generic [ref=e12]:
          - generic [ref=e13]: Talantlar bazasiga qo'shilish
          - generic [ref=e14]: Rezyumengizni tayyorlab turing
        - img [ref=e15]
      - generic [ref=e19]: "*Careers bo'limi mentorlar tomonidan tasdiqlangan o'quvchilar uchun ochiladi."
```
