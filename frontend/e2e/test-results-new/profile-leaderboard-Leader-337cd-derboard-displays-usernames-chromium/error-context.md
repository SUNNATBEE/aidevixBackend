...
- Name: profile-leaderboard.spec.ts >> Leaderboard Page >> leaderboard displays usernames
- Location: e2e\profile-leaderboard.spec.ts:101:7
...
Call log:
  - navigating to "http://localhost:3001/leaderboard", waiting until "load"
