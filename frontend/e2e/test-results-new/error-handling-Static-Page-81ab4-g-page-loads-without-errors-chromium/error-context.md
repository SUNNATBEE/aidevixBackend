...
- Name: error-handling.spec.ts >> Static Pages Load >> Pricing page loads without errors
...
Call log:
  - navigating to "http://localhost:3001/pricing", waiting until "load"
...
- main [ref=e2]:
  - generic [ref=e4]:
    - heading "Tariflar va Narxlar" [level=1] [ref=e5]
    - paragraph [ref=e6]: Siz uchun eng ma'qul ta'lim paketini tanlang.
```
